...
pub mod stardust_xr {
	...
	impl<'a> Message<'a> {
		...
		pub fn object(&self) -> Option<&'a str> {
			self._tab
				.get::<flatbuffers::ForwardsUOffset<&str>>(Message::VT_OBJECT, None)
		}
		#[inline]
		pub fn method(&self) -> Option<&'a str> {
			self._tab
				.get::<flatbuffers::ForwardsUOffset<&str>>(Message::VT_METHOD, None)
		}
		#[inline]
	...
	impl<'a: 'b, 'b> MessageBuilder<'a, 'b> {
		...
		pub fn add_object(&mut self, object: flatbuffers::WIPOffset<&'b str>) {
			self.fbb_
				.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_OBJECT, object);
		}
		#[inline]
		pub fn add_method(&mut self, method: flatbuffers::WIPOffset<&'b str>) {
			self.fbb_
				.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_METHOD, method);
		}
		#[inline]
