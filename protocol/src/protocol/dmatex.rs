...
impl gluon_ipc::Convertable for DmatexFormat {
    fn write(
        &self,
    ...
    fn read(
        ...
        let drm_fourcc = gluon_ipc::Convertable::read(gluon_data)?;
        let drm_modifier = gluon_ipc::Convertable::read(gluon_data)?;
        let is_srgb = gluon_ipc::Convertable::read(gluon_data)?;
        let alpha_mode = gluon_ipc::Convertable::read(gluon_data)?;
        let ycbcr_info = gluon_ipc::Convertable::read(gluon_data)?;
        Ok(DmatexFormat {
            drm_fourcc,
            drm_modifier,
            is_srgb,
...
impl gluon_ipc::Convertable for DmatexFormatInfo {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
    ...
    fn read(
        ...
        let drm_fourcc = gluon_ipc::Convertable::read(gluon_data)?;
        let drm_modifier = gluon_ipc::Convertable::read(gluon_data)?;
        let supports_srgb = gluon_ipc::Convertable::read(gluon_data)?;
        let supports_disjoint = gluon_ipc::Convertable::read(gluon_data)?;
        let supports_sampling = gluon_ipc::Convertable::read(gluon_data)?;
        let supports_rendering = gluon_ipc::Convertable::read(gluon_data)?;
        Ok(DmatexFormatInfo {
            drm_fourcc,
            drm_modifier,
            supports_srgb,
...
impl gluon_ipc::Convertable for DmatexPlane {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
    ...
    fn read(
        ...
        let offset = gluon_ipc::Convertable::read(gluon_data)?;
        let row_size = gluon_ipc::Convertable::read(gluon_data)?;
        let array_element_size = gluon_ipc::Convertable::read(gluon_data)?;
        let depth_slice_size = gluon_ipc::Convertable::read(gluon_data)?;
        Ok(DmatexPlane {
            offset,
            row_size,
            array_element_size,
...
impl gluon_ipc::Convertable for DisjointDmatexPlane {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
    ...
    fn read(
        ...
        let dmabuf_fd = gluon_ipc::Convertable::read(gluon_data)?;
        let plane = gluon_ipc::Convertable::read(gluon_data)?;
...
impl gluon_ipc::Convertable for YcbcrFormat {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
    ...
    fn read(
        ...
        let coefficients = gluon_ipc::Convertable::read(gluon_data)?;
        let range = gluon_ipc::Convertable::read(gluon_data)?;
        let chroma_location_x = gluon_ipc::Convertable::read(gluon_data)?;
        let chroma_location_y = gluon_ipc::Convertable::read(gluon_data)?;
        Ok(YcbcrFormat {
            coefficients,
            range,
            chroma_location_x,
...
impl gluon_ipc::Convertable for DmatexSize {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
            ...
            match gluon_data.read_u16()? {
                ...
                1u16 => {
                    let size: crate::types::Size2 = {
                        let __w: super::types::proxied::Size2 = gluon_ipc::Convertable::read(
                            gluon_data,
                        )?;
                        __w.into()
                    };
                ...
                2u16 => {
                    let size: crate::types::Size3 = {
                        let __w: super::types::proxied::Size3 = gluon_ipc::Convertable::read(
                            gluon_data,
                        )?;
                        __w.into()
                    };
...
impl gluon_ipc::Convertable for DmatexPlanes {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
    ...
    fn read(
        ...
        Ok(
            match gluon_data.read_u16()? {
                0u16 => {
                    let dmabuf_fd = gluon_ipc::Convertable::read(gluon_data)?;
                    let planes = gluon_ipc::Convertable::read(gluon_data)?;
                    DmatexPlanes::Simple {
                        dmabuf_fd,
                        planes,
                    }
...
impl gluon_ipc::Convertable for AlphaMode {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Convertable for YcbcrCoefficients {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Convertable for YcbcrChromaLocation {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Convertable for YcbcrRange {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Convertable for DmatexImportError {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
    ...
    fn read(
        ...
        Ok(
            match gluon_data.read_u16()? {
                ...
                2u16 => {
                    let max_supported_layers = gluon_ipc::Convertable::read(gluon_data)?;
...
impl gluon_ipc::Convertable for DmatexRef {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Interface for DmatexRef {
...
impl<H: DmatexRefHandler> gluon_ipc::HandledBy<H> for DmatexRef {}
...
pub type DmatexRefLocal<H> = gluon_ipc::LocalRef<DmatexRef, H>;
...
impl gluon_ipc::RefExt for DmatexRef {
    fn from_ref(obj: gluon_ipc::Ref) -> DmatexRef {
        DmatexRef { obj }
    }
}
impl DmatexRef {
    ///only use this when you know the ref leads to something implementing this interface, else the consquences are for you to find out
    pub fn from_ref(obj: gluon_ipc::Ref) -> DmatexRef {
        DmatexRef { obj }
    }
}
impl From<DmatexRef> for gluon_ipc::Ref {
    fn from(value: DmatexRef) -> Self {
        value.obj
    }
}
impl gluon_ipc::ToRef for DmatexRef {
    fn to_ref(&self) -> gluon_ipc::Ref {
        self.obj.clone()
    }
}
impl gluon_ipc::Liveness for DmatexRef {
...
pub trait DmatexRefHandler: gluon_ipc::Handler + Send + Sync + 'static {
    fn dispatch_one_way(
        &self,
    ...
    fn to_node(
        ...
        (gluon_ipc::Node<Self>, gluon_ipc::LocalRef<DmatexRef, Self>),
        gluon_ipc::NodeError,
    >
    where
        Self: Sized,
    ...
    fn to_service(
        self,
    ) -> Result<gluon_ipc::LocalRef<DmatexRef, Self>, gluon_ipc::NodeError>
    where
        Self: Sized,
    {
        use gluon_ipc::RefExt;
...
impl gluon_ipc::Convertable for DmatexInterface {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Interface for DmatexInterface {
    const ID: &'static str = Self::ID;
}
///Carries the per-interface bound for [`gluon_ipc::RefExt`]'s handler constructors: only a handler implementing this interface's handler trait can be passed to them.
impl<H: DmatexInterfaceHandler> gluon_ipc::HandledBy<H> for DmatexInterface {}
///A proxy this process made, carrying the handler behind it — see [`gluon_ipc::LocalRef`]. Handed back by [`gluon_ipc::RefExt::new_node`] and [`gluon_ipc::RefExt::new_service`].
pub type DmatexInterfaceLocal<H> = gluon_ipc::LocalRef<DmatexInterface, H>;
///Drops the handler share and keeps the proxy, so a [`gluon_ipc::LocalRef`] goes anywhere this proxy does — including the `impl Into<Self>` parameters generated for typed refs.
...
impl gluon_ipc::RefExt for DmatexInterface {
    fn from_ref(obj: gluon_ipc::Ref) -> DmatexInterface {
        DmatexInterface { obj }
    }
}
impl DmatexInterface {
    pub async fn import_dmatex(
    ...
    ) -> Result<Result<DmatexRef, DmatexImportError>, gluon_ipc::SendError> {
        ...
        let __ret_dmatex = gluon_ipc::Convertable::read(&mut reader)?;
        tracing::trace!(
    ...
    pub async fn enumerate_formats(
    ...
    ) -> Result<Option<Vec<DmatexFormatInfo>>, gluon_ipc::SendError> {
        ...
        let mut reader = gluon_recv.recv().await.unwrap();
        let __ret_formats = gluon_ipc::Convertable::read(&mut reader)?;
        tracing::trace!(
    ...
    pub async fn primary_render_node_id(&self) -> Result<u64, gluon_ipc::SendError> {
        tracing::trace!(
        ...
        let mut reader = gluon_recv.recv().await.unwrap();
        let __ret_drm_render_node_id = gluon_ipc::Convertable::read(&mut reader)?;
        tracing::trace!(
            interface = "DmatexInterface", method = "primary_render_node_id", ?
    ...
    ///only use this when you know the ref leads to something implementing this interface, else the consquences are for you to find out
    pub fn from_ref(obj: gluon_ipc::Ref) -> DmatexInterface {
        DmatexInterface { obj }
    }
}
impl From<DmatexInterface> for gluon_ipc::Ref {
    fn from(value: DmatexInterface) -> Self {
        value.obj
    }
}
impl gluon_ipc::ToRef for DmatexInterface {
    fn to_ref(&self) -> gluon_ipc::Ref {
        self.obj.clone()
    }
}
impl gluon_ipc::Liveness for DmatexInterface {
    fn death_notifier(&self) -> gluon_ipc::DeathNotifier {
        gluon_ipc::Liveness::death_notifier(&self.obj)
    }
}
...
pub trait DmatexInterfaceHandler: gluon_ipc::Handler + Send + Sync + 'static {
    fn import_dmatex(
        &self,
    ...
    fn import_dmatex_oneway(
        ...
        planes: DmatexPlanes,
        timeline_syncobj_fd: std::os::fd::OwnedFd,
        reply: gluon_ipc::ReplySender<Result<DmatexRef, DmatexImportError>>,
    ) -> impl Future<Output = Result<(), gluon_ipc::SendError>> + Send + Sync {
        async move {
            let dmatex = self
                .import_dmatex(
    ...
    fn enumerate_formats_oneway(
        ...
        _ctx: gluon_ipc::Context,
        render_node: u64,
        reply: gluon_ipc::ReplySender<Option<Vec<DmatexFormatInfo>>>,
    ) -> impl Future<Output = Result<(), gluon_ipc::SendError>> + Send + Sync {
        async move {
    ...
    fn primary_render_node_id_oneway(
        &self,
        _ctx: gluon_ipc::Context,
        reply: gluon_ipc::ReplySender<u64>,
    ) -> impl Future<Output = Result<(), gluon_ipc::SendError>> + Send + Sync {
        async move {
        ...
        async move {
            match transaction_code {
                8u32 => {
                    ...
                    let param_size = gluon_ipc::Convertable::read(&mut gluon_data)?;
                    let param_format = gluon_ipc::Convertable::read(&mut gluon_data)?;
                    let param_array_layers = gluon_ipc::Convertable::read(
                        &mut gluon_data,
                    )?;
                    let param_planes = gluon_ipc::Convertable::read(&mut gluon_data)?;
                    let param_timeline_syncobj_fd = gluon_ipc::Convertable::read(
                        &mut gluon_data,
                    )?;
                    tracing::trace!(
                ...
                9u32 => {
                    let return_callback = gluon_data.read_ref()?;
                    let param_render_node = gluon_ipc::Convertable::read(
                        &mut gluon_data,
                    )?;
                    tracing::trace!(
                    ...
                    drop(gluon_data);
                    let reply: gluon_ipc::ReplySender<Option<Vec<DmatexFormatInfo>>> = gluon_ipc::ReplySender::new(
                        return_callback,
                        |formats, gluon_out| {
                            tracing::trace!(
                                interface = "DmatexInterface", method = "enumerate_formats",
                ...
                10u32 => {
                    ...
                    drop(gluon_data);
                    let reply: gluon_ipc::ReplySender<u64> = gluon_ipc::ReplySender::new(
                        return_callback,
    ...
    fn to_node(
        ...
        (gluon_ipc::Node<Self>, gluon_ipc::LocalRef<DmatexInterface, Self>),
        gluon_ipc::NodeError,
    >
    where
        Self: Sized,
    ...
    fn to_service(
        self,
    ) -> Result<gluon_ipc::LocalRef<DmatexInterface, Self>, gluon_ipc::NodeError>
    where
        Self: Sized,
    {
        use gluon_ipc::RefExt;
...
impl gluon_ipc::Convertable for DmatexSubmitRelease {
    fn write(
        &self,
        gluon_data: &mut gluon_ipc::DataBuilder,
    ) -> Result<(), gluon_ipc::WriteError> {
...
impl gluon_ipc::Interface for DmatexSubmitRelease {
    const ID: &'static str = Self::ID;
}
///Carries the per-interface bound for [`gluon_ipc::RefExt`]'s handler constructors: only a handler implementing this interface's handler trait can be passed to them.
impl<H: DmatexSubmitReleaseHandler> gluon_ipc::HandledBy<H> for DmatexSubmitRelease {}
///A proxy this process made, carrying the handler behind it — see [`gluon_ipc::LocalRef`]. Handed back by [`gluon_ipc::RefExt::new_node`] and [`gluon_ipc::RefExt::new_service`].
pub type DmatexSubmitReleaseLocal<H> = gluon_ipc::LocalRef<DmatexSubmitRelease, H>;
///Drops the handler share and keeps the proxy, so a [`gluon_ipc::LocalRef`] goes anywhere this proxy does — including the `impl Into<Self>` parameters generated for typed refs.
...
impl gluon_ipc::RefExt for DmatexSubmitRelease {
    fn from_ref(obj: gluon_ipc::Ref) -> DmatexSubmitRelease {
        DmatexSubmitRelease { obj }
    }
}
impl DmatexSubmitRelease {
    ///Consume the release point, after you get the release point you have to signal it at some point!
    pub async fn consume(&self) -> Result<u64, gluon_ipc::SendError> {
        ...
        gluon_ipc::transact(&self.obj, 8u32, gluon_builder)?;
        let mut reader = gluon_recv.recv().await.unwrap();
        let __ret_release_point = gluon_ipc::Convertable::read(&mut reader)?;
        tracing::trace!(
    ...
    ///only use this when you know the ref leads to something implementing this interface, else the consquences are for you to find out
    pub fn from_ref(obj: gluon_ipc::Ref) -> DmatexSubmitRelease {
        DmatexSubmitRelease { obj }
    }
}
impl From<DmatexSubmitRelease> for gluon_ipc::Ref {
    fn from(value: DmatexSubmitRelease) -> Self {
        value.obj
    }
}
impl gluon_ipc::ToRef for DmatexSubmitRelease {
    fn to_ref(&self) -> gluon_ipc::Ref {
        self.obj.clone()
    }
}
impl gluon_ipc::Liveness for DmatexSubmitRelease {
    fn death_notifier(&self) -> gluon_ipc::DeathNotifier {
        gluon_ipc::Liveness::death_notifier(&self.obj)
    }
}
...
pub trait DmatexSubmitReleaseHandler: gluon_ipc::Handler + Send + Sync + 'static {
    ///Consume the release point, after you get the release point you have to signal it at some point!
    fn consume(
        &self,
        _ctx: gluon_ipc::Context,
    ...
    fn to_node(
        ...
        (gluon_ipc::Node<Self>, gluon_ipc::LocalRef<DmatexSubmitRelease, Self>),
        gluon_ipc::NodeError,
    >
    where
        Self: Sized,
    ...
    fn to_service(
        self,
    ) -> Result<gluon_ipc::LocalRef<DmatexSubmitRelease, Self>, gluon_ipc::NodeError>
    where
        Self: Sized,
    {
        use gluon_ipc::RefExt;
