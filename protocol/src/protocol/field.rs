        ...
        async move {
            match transaction_code {
                8u32 => {
                    ...
                    self.field_ref_oneway(ctx, reply)
                        .instrument(
                            tracing::trace_span!(
                                "dispatching", interface = "Field", method = "field_ref",
                                method_id = 8u32
                            ),
                        )
                        .await?;
                ...
                10u32 => {
                    ...
                    tracing::trace!(
                        ...
                        param_point = ? __wire_param_point, "dispatching"
                    );
                    ...
                    let reply: gluon::ReplySender<FieldSample> = gluon::ReplySender::new(
                        ...
                        |result, gluon_out| {
                            ...
                            result.write_owned(gluon_out)?;
                            Ok(())
                        },
                    );
                    self.sample_oneway(ctx, param_reference_space, param_point, reply)
                        .instrument(
                            tracing::trace_span!(
                ...
                11u32 => {
                    ...
                    tracing::trace!(
                        interface = "Field", method = "ray_march", ?
                        param_reference_space, param_ray_origin = ?
                ...
                12u32 => {
                    ...
                    drop(gluon_data);
                    self.set_shape(ctx, param_shape)
                        .instrument(
                            tracing::trace_span!(
            ...
            match transaction_code {
                8u32 => {
                    ...
                    tracing::trace!(
                        ...
                        param_space, param_point = ? __wire_param_point, "dispatching"
                    );
                    let param_point: crate::types::Vec3F = {
                        let __w = __wire_param_point;
                        __w.into()
                    ...
                    self.sample_oneway(ctx, param_field, param_space, param_point, reply)
                        .instrument(
                            tracing::trace_span!(
                                "dispatching", interface = "FieldInterface", method =
                                "sample", method_id = 8u32
                            ),
                        )
                        .await?;
                }
                9u32 => {
                    ...
                    tracing::trace!(
                        interface = "FieldInterface", method = "ray_march", ?
                        param_field, ? param_space, param_ray_origin = ?
                        __wire_param_ray_origin, param_ray_direction = ?
                        __wire_param_ray_direction, "dispatching"
                    );
                    let param_ray_origin: crate::types::Vec3F = {
                ...
                10u32 => {
                    ...
                    self.create_field_oneway(ctx, param_spatial, param_shape, reply)
                        .instrument(
                            tracing::trace_span!(
                                "dispatching", interface = "FieldInterface", method =
                                "create_field", method_id = 10u32
                            ),
                        )
                        .await?;
                }
